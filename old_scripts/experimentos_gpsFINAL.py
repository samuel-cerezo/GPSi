...
#dataset_path = '/Users/samucerezo/dev/src/repos/GPSi/datasets/GVINS'

dataset_path = '/Users/samucerezo/dev/src/repos/GPSi/datasets/EuRoc/MH_03_medium'
gps_noise_std = 0.2     #0.1
...
def main(dataset_path, output_filename):
    ...
    CSV_filename = output_filename + "-con-rel.csv"
